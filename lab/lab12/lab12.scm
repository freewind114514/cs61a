...
(define (closer-city lat lon city-a city-b)
  ...
  (if 
  (< (distance city-a city-c) (distance city-b city-c))
  (get-name city-a)
  (get-name city-b)
  )
  )
...
(define (teacher-hold-class teacher)
  (define t-name (teacher-get-name teacher))
  (define t-class (teacher-get-class teacher))
  (define t-students (teacher-get-students teacher))
  (define (attend student) (student-attend-class student t-class))
  (define new-students (map attend t-students))
  (teacher-create t-name t-class new-students)
  )
